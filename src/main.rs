...
fn App() -> impl IntoView {
    ...
    const COL_STYLE: &str = "w-1/4 p-8 m-8 rounded-md bg-surface-a drop-shadow-xl";

    view! {
        <section class="flex justify-center min-h-screen max-h-screen bg-dark text-text-color">
